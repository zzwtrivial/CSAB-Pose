...
class Config:
    ...
    use_GT_bbox = True
    # if use_GT_bbox:
    gt_path = os.path.join(root_dir, r'E:\Final\Annotations\ExLPose', 'ExLPose_test_LL-Hard_trans.json')
    ori_gt_path = os.path.join(root_dir, r'E:\Final\Annotations\ExLPose', 'ExLPose_test_LL-Hard.json')
