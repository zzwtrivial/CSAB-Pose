...
def main(args):
    ...
    model = network.__dict__["CIConv_CPN50"](cfg.output_shape, cfg.num_class, pretrained=False)
    ...
    train_loader = torch.utils.data.DataLoader(
        # LmdbDataset("/home/wjm/MyFinalProject/ZeroShotDayNightDA/WL.lmdb", cfg),
...
if __name__ == '__main__':
    ...
    parser.set_defaults(start_epoch=0, workers=12, num_gpus=1, epochs=20, checkpoint='checkpoint')
