...
class ResNet50_BYOL(nn.Module):

    def __init__(self, resnet, pretrained=False, m=0.99):
        # TODO fix bn_running_stats
        self.m = m

        super(ResNet50_BYOL, self).__init__()

        self.resnet = resnet
        self.encoder_k = resnet50(pretrained=pretrained)
